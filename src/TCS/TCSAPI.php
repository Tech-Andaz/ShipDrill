    ...
    public function getFormFields($config)
    {
        ...
        $form_fields = array(
            array(
                ...
                "type" => "select",
                "default" => isset($config['cost_center']) && in_array($config['cost_center'], $this->andaz_array_column($cost_centers)) ? $config['cost_center'] : $cost_centers[0]['value'],
            ...
            array(
                ...
                "type" => "select",
                "default" => isset($config['consignee_city']) && in_array(strtoupper($config['consignee_city']), $this->andaz_array_column($cities)) ? $config['consignee_city'] : "",
                "options" => $cities,
            ...
            array(
                ...
                "type" => "select",
                "default" => isset($config['service_id']) && in_array($config['service_id'], $this->andaz_array_column($services)) ? $config['service_id'] : $services[0]['value'],
                "options" => $services,
            ...
            array(
                ...
                "type" => "select",
                "default" => isset($config['fragile']) && in_array($config['fragile'], $this->andaz_array_column($fragile)) ? $config['fragile'] : $fragile[0]['value'],
                "options" => $fragile,
